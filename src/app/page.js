  ...
  return (
    <div className="w-full h-[4474px] relative bg-white  overflow-hidden">
      ...
      <img
        src="/images/logo.svg"
        alt="Logo"
        className="w-[180px] h-auto absolute top-[80px] left-[115px]"
      />

      {/* Navigation Menu */}
      <div className="left-[472.50px] top-[79px] absolute">
        <div className="h-[27px] left-0 top-[14px] absolute justify-start items-start gap-[76px] inline-flex">
          <div className="w-[78px] h-[27px] text-center text-[#4974ce] text-base font-normal font-['Poppins'] capitalize">Inicio</div>
          <div className="w-[127px] h-[27px] text-center text-black text-base font-normal font-['Poppins'] capitalize">Servicios</div>
          <div className="w-[131px] h-[27px] text-center text-black text-base font-normal font-['Poppins'] capitalize">Sobre nosotros</div>
          <div className="w-[93px] h-[27px] text-center text-black text-base font-normal font-['Poppins'] capitalize">Blog</div>
        </div>
        ...
        <div className="w-[169px] h-[54px] left-[793.50px] top-0 absolute">
          ...
          <div className="w-[124px] h-[30px] left-[23px] top-[12px] absolute text-center text-white text-base font-semibold font-['Poppins'] capitalize">Contacto</div>
        </div>
      </div>
      ...
      <svg className="w-[432px] h-[468px] left-[687px] top-[263px] absolute rounded-[20px]" xmlns="http://www.w3.org/2000/svg" width="432" height="468" viewBox="0 0 432 468" fill="none">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M0 20C0 8.95431 8.9543 0 20 0H205C216.046 0 225 8.95432 225 20V188.128C225 192.62 226.512 196.982 229.293 200.51L256.783 235.382C260.575 240.192 266.364 243 272.49 243H412C423.046 243 432 251.954 432 263V448C432 459.046 423.046 468 412 468H227C215.954 468 207 459.046 207 448V289.908C207 285.416 205.488 281.055 202.707 277.527L167.305 232.618C163.513 227.808 157.725 225 151.599 225H20C8.95431 225 0 216.046 0 205V20Z" fill="#4974CE" />
      </svg>

      <div className="w-[452px] h-[163px] left-[887px] top-[824px] absolute">
        <div className="w-[192.74px] h-[45px] left-0 top-0 absolute bg-[#5096ca]/0 rounded-[36px] border border-black" />
        <div className="w-[192.74px] h-[45px] left-0 top-[118px] absolute bg-[#5096ca]/0 rounded-[36px] border border-black" />
        <div className="w-[184px] h-[29px] left-[3px] top-[6px] absolute text-center text-black text-base font-normal font-['Poppins'] capitalize leading-tight">Desarrollo Back-End</div>
        <div className="w-[184px] h-[29px] left-[3px] top-[124px] absolute text-center text-black text-base font-normal font-['Poppins'] capitalize leading-tight">Dev-Ops</div>
        <div className="w-[184px] h-[29px] left-[223px] top-[6px] absolute text-center text-black text-base font-normal font-['Poppins'] capitalize leading-tight">Desarrollo Front-End</div>
        <div className="w-[184px] h-[29px] left-[223px] top-[124px] absolute text-center text-black text-base font-normal font-['Poppins'] capitalize leading-tight">Otros roles</div>
        <div className="w-[229px] h-[29px] left-[223px] top-[67px] absolute text-center text-black text-base font-normal font-['Poppins'] capitalize leading-tight">Aseguramiento de calidad</div>
        <div className="w-[184px] h-[29px] left-[3px] top-[67px] absolute text-center text-black text-base font-normal font-['Poppins'] capitalize leading-tight">Desarrollo Full stack</div>
      </div>
      ...
      <div className="w-[1299px] h-[615px] left-[114px] top-[1053px] absolute">
        ...
        <div className="w-[511px] h-[558px] left-[788px] top-[57px] absolute bg-gradient-to-b from-[#4974ce] to-[#55b6c5] rounded-[78px]"></div>
      </div>
      ...
      <div className="w-[1335px] h-[797.72px] left-[78px] top-[2262px] absolute">
        <div className="w-[671px] h-[432.72px] left-0 top-0 absolute">
          <div className="w-[430.30px] h-[305.72px] left-0 top-[432.72px] absolute">
          </div>
        ...
        <div className="w-[430.30px] h-[305.72px] left-[215px] top-[797.72px] absolute">
        </div>
        <div className="w-[430.30px] h-[305.72px] left-[452.23px] top-[432.72px] absolute">
        </div>
        <div className="w-[430.30px] h-[305.72px] left-[667.23px] top-[797.72px] absolute">
        </div>
        <div className="w-[430.30px] h-[305.72px] left-[904.70px] top-[432.72px] absolute">
        </div>
      </div>
